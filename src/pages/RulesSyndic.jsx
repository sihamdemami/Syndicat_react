...
const Rules = () => {
  ...
  // Exécutez cette fonction pour récupérer les données de la base de données
  useEffect(() => {
    // Votre logique pour récupérer les données de la base de données ici
    // Remplacez l'exemple de données ci-dessous par les données réelles de votre base de données
    const fetchData = async () => {
      try {
        const response = await fetch(`http://127.0.0.1:8000/api/getregle/${idCoproperty}`);
