...
import { AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock,AiOutlineHome, AiOutlineEdit, AiOutlineDelete } from 'react-icons/ai';
import { FiShoppingBag, FiEdit, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiShoppingCart ,FiUser, FiUserPlus} from 'react-icons/fi';
import { BsKanban, BsBarChart,BsGeoAlt, BsBoxSeam,BsChatLeftText, BsCurrencyDollar, BsHouseDoor,BsShield, BsChatLeft ,BsBuildings} from 'react-icons/bs';
import { BiColorFill ,BiReceipt, BiShow} from 'react-icons/bi';
import { IoMdContacts,IoMdHammer ,IoMdDocument } from 'react-icons/io';
import { RiContactsLine, RiStockLine } from 'react-icons/ri';
import { MdOutlineSupervisorAccount ,MdBalance, MdOutlinePriceChange,MdOutlinePayments } from 'react-icons/md';
...
import Charge from './Charges.jpg';
import Budget from './Budget.jpg';
import Factures from './Factures.jpg';
import Coproperty from './image 3.jpg';
import Rules from './Rules.jpg';
import Documents from './Document.jpg';
import travaux from './Travaux.jpg';
...
const gridCopropertyImage = (props) => (
...
export const customersGrid = [
  ...
  { field: 'nombre_appartement',
    headerText: 'Appartments',
    width: '100',
    format: 'yMd',
    textAlign: 'Center' },
...
export const CopropertyData = [
  {
    title: 'Charge',
    Description: ' Identifiez et évaluez les charges courantes liées à la copropriété, telles que les frais de maintenance, les services publics et les dépenses collectives, pour une gestion transparente et équitable.',
    CopropertyImage:
    Charge,
  },
  ...
  {
    title: 'Budget',
    Description: ' Suivez les dépenses et les revenus de votre copropriété pour maintenir une gestion financière saine et planifier efficacement l allocation des ressources.',
    CopropertyImage:
    Budget,
  },
  ...
  {
    title: 'Rules',
    Description: 'Familiarisez-vous avec les droits et responsabilités des copropriétaires, y compris les règles de conduite, les droits de vote et les privilèges, pour favoriser une communauté harmonieuse et respectueuse.',
    CopropertyImage:
    Rules,
  },
  ...
  {
    title: 'Documents',
    Description: 'Accédez rapidement aux documents essentiels de la copropriété, tels que les contrats, les règlements internes, les procès-verbaux des réunions, pour une gestion organisée et une communication transparente.',
    CopropertyImage:
    Documents,
  },
  ...
  {
    title: 'travaux',
    Description: ' Planifiez, suivez et gérez les travaux de maintenance et de réparation nécessaires dans la copropriété, garantissant ainsi un environnement sûr, fonctionnel et attrayant pour tous les copropriétaires.',
    CopropertyImage:
    travaux,
  },
...
export const CopropertyDataSyndic = [
  {
    title: 'Charge',
    Description: ' Identifiez et évaluez les charges courantes liées à la copropriété, telles que les frais de maintenance, les services publics et les dépenses collectives, pour une gestion transparente et équitable.',
    CopropertyImage:
...
export const links_syndic= [
  ...
  },
  {
    ...
    links: [
      {
          name: 'CopropertyManagement',
          icon: <BsBuildings />,
      },
      {
        name: 'PropertiesManagments',
        icon: <BsHouseDoor />,
      },  
      {
        name: 'Facture',
...
export const productsPerformance = [
  {
    image:
      product5,
    Email: 'Is it good butterscotch ice-cream?',
  ...
  },
  {
    image:
      product6,
    Email: 'Supreme fresh tomato available',
    desc: 'Market, Mall',
    rating: 'Excellent',
    itemSold: '98%',
  ...
  },
  {
    image:
      product7,
    Email: 'Red color candy from Gucci',
  ...
  },
  {
    image:
      product4,
    Email: 'Stylish night lamp for night',
...
export const customersData = [
  {
    ID: 1,
    Name: 'Rahma ',
    Adress: '41,rue 22,Fes',
    Zip_Code: '30000',
    City: 'Fes',
    
    nombre_appartement: '40',
    Etage: '3',
